...
###############################
# ONLYOFFICE Deafult settings #
###############################
VERIFY_ONLYOFFICE_CERTIFICATE = False
ONLYOFFICE_DOCUMENT_SERVER_ADDRESS = 'http://<documentserver-host>:<documentserver-port>/'
...
CONSTANCE_CONFIG = {
    ...
    'VERIFY_ONLYOFFICE_CERTIFICATE': (VERIFY_ONLYOFFICE_CERTIFICATE, ''),
    'ONLYOFFICE_DOCUMENT_SERVER_ADDRESS': (ONLYOFFICE_DOCUMENT_SERVER_ADDRESS, ''),
